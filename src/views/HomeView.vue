<template>
  ...
  <div class="container mx-auto">
    <div class="flex items-center justify-between flex-col-reverse md:flex-row mx-auto pt-16">
      <div class="md:w-5/12 mb:p-0 p-4">
        ...
        <p class="mb-8">
          At Green Life Company, we are committed to preserving the environment by monitoring
          pollution and assessing environmental impacts, and developing innovative solutions to
          reduce negative effects. We strive to ensure compliance with environmental standards and
          provide guidance to companies for achieving sustainable performance. We raise
          environmental awareness through awareness campaigns and training programs to encourage
  ...
  <div class="container mx-auto my-28 relative">
    ...
    <div
      class="max_md:hidden text-2xl w-72 pt-16 px-6 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-700 before:absolute before:w-7/12 before:h-full before:top-0 before:left-0 before:bg-gray-100 before:-z-10"
    >
      Mina title for this slide title for this slid
    </div>
  ...
  <div class="container mx-auto my-28">
    ...
    >
      ...
      <div class="w-5/12 max_md:hidden mx-8">
        <div>
          <h2 class="text-2xl text-black mb-4">Our Team Leaders</h2>
          <p class="text-gray-500">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae repudiandae minus quia
            fugit. Perspiciatis ea praesentium ab repellendus maxime, veniam maiores architecto
            dicta, ad suscipit, sit asperiores nulla unde necessitatibus!ium ab repellendus maxime,
            veniam maiores architecto dicta, ad suscipit, sit asperiores nulla unde necessitatibus!
          </p>
        </div>
